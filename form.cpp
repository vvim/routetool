...
void Form::drawRoute()
{
    ...
    if(m_markers.length() > 1)
    {
        ...
        QString html_top = QString("<!DOCTYPE html> <html> <head> <meta name=\"viewport\" content=\"initial-scale=1.0, user-scalable=no\" /> <style type=\"text/css\"> html { height: 100% } body { height: 100%; margin: 0; padding: 0 } #map_canvas { height: 100% } </style> <script src=\"https://maps.googleapis.com/maps/api/js?v="+GOOGLEMAPSOLDERVERSION+"&key=")+
