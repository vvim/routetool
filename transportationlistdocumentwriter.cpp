...
TransportationListDocumentWriter::TransportationListDocumentWriter(const QString &address, const QString &legal, const QString &date)
...
void TransportationListDocumentWriter::addVisit(
              const TransportationListDocumentWriter::VisitLocation &location)
{
...
QString TransportationListDocumentWriter::seconds_human_readable(int totalseconds)
{
